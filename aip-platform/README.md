...
Use page source to verify marker: `meta name="aip-ui-version" content="saas-v3-20260304c"`.


### Verify Latest UI Version

Open page source on deployed URL and confirm:

`<meta name="aip-ui-version" content="saas-v3-20260304c">`

If this marker is missing, the deployment is serving an older commit/root directory.
